<template>
  <div class="flex flex-col gap-[2rem] p-2">
    ...
    >
      ...
      <p class="font-geologica text-white text-[1rem]">Основан на твоем опыте</p>
    </div>
    ...
    <div class="flex flex-col gap-[1rem] mt-2">
      <router-link
        :to="courseLink"
        class="btn-cta w-full text-center flex justify-center items-center"
      >
...
defineProps<{ resultText: string; courseLink: string }>()
